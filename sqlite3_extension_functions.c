    ...
    "fetchList": [
        {
            "replaceList": [
                ...
                {
                    "aa": "\\b(?:READ_UTF8|logFunc|piFunc|signFunc|sqlite3Utf8CharLen)\\b",
                    "bb": "$&_2",
                    "flags": "g",
                    "substr": ""
                }
...
** in the READ_UTF8_2 macro explains things best.
*/
...
*/
static int sqlite3Utf8CharLen_2(const char *z, int nByte){
  int r = 0;
  const char *zTerm;
  if( nByte>=0 ){
    zTerm = &z[nByte];
