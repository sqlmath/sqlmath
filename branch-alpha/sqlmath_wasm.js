...
function sqlWorkerDispatch(data) {
 ...
 case "_dbTableInsert":
  try {
   ...
   baton.set(new Uint8Array(HEAPU8.buffer, HEAPU8.byteOffset + ptr, 1024));
...
var _dbMemoryLoadOrSave = Module["_dbMemoryLoadOrSave"] = createExportWrapper("dbMemoryLoadOrSave");
