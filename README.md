...
# Status
| Branch | [master<br>(v2026.2.1)](https://github.com/sqlmath/sqlmath/tree/master) | [beta<br>(Web Demo)](https://github.com/sqlmath/sqlmath/tree/beta) | [alpha<br>(Development)](https://github.com/sqlmath/sqlmath/tree/alpha) |
|--:|:--:|:--:|:--:|
...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2026.2.1*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2026.2.1
#
twine upload dist/sqlmath-2026.2.1*
pip install sqlmath==2026.2.1
```
