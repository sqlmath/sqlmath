...
| Branch | [master<br>(v2026.8.31)](https://github.com/sqlmath/sqlmath/tree/master) | [beta<br>(Web Demo)](https://github.com/sqlmath/sqlmath/tree/beta) | [alpha<br>(Development)](https://github.com/sqlmath/sqlmath/tree/alpha) |
|--:|:--:|:--:|:--:|
...
- sqlmath installs via `pip install sqlmath==2026.8.31`
...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2026.8.31*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2026.8.31
#
twine upload dist/sqlmath-2026.8.31*
pip install sqlmath==2026.8.31
```
...
```shell
    ...
    #
    # lgbm
    sh jslint_ci.sh shRollupUpgrade "v4.6.0" "v4.7.0" ".ci.sh sqlmath_base.h"
    #
    # sqlite
    sh jslint_ci.sh shRollupUpgrade "3.50.4" "3.51.3" ".ci.sh sqlmath_external_sqlite.c"
    sh jslint_ci.sh shRollupUpgrade "3500400" "3510300" ".ci.sh sqlmath_external_sqlite.c"
    #
    # shSqlmathUpdate
