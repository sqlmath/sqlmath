...
| Branch | [master<br>(v2026.5.31)](https://github.com/sqlmath/sqlmath/tree/master) | [beta<br>(Web Demo)](https://github.com/sqlmath/sqlmath/tree/beta) | [alpha<br>(Development)](https://github.com/sqlmath/sqlmath/tree/alpha) |
|--:|:--:|:--:|:--:|
...
- sqlmath installs via `pip install sqlmath==2026.5.31`
...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2026.5.31*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2026.5.31
#
twine upload dist/sqlmath-2026.5.31*
pip install sqlmath==2026.5.31
```
