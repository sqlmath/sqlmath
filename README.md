...
- sqlmath installs via `pip install sqlmath==2026.5.1`
...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2026.5.1*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2026.5.1
#
twine upload dist/sqlmath-2026.5.1*
pip install sqlmath==2026.5.1
```
