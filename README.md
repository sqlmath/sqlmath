...
python -m build
#
twine upload --repository testpypi dist/sqlmath-2023.12.1*
py -m pip install --index-url https://test.pypi.org/simple/ sqlmath==2023.12.1
#
twine upload dist/sqlmath-2023.12.1*
pip install sqlmath==2023.12.1
```
